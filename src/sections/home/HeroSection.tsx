  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 xl:px-12 pt-20">
        <div className="max-w-3xl mr-auto text-right">
          ...
          >
            ...
            <span className="text-[#DC2626] text-sm font-medium">منصة قطع الغيار الأولى في قطر</span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-white/70 mb-8 max-w-xl mr-auto"
          >
            اكتشف تشكيلتنا الواسعة من قطع الغيار الأصلية والإكسسوارات عالية الجودة. 
            نوفر لك تجربة تسوق سهلة مع أفضل المحلات والمراكز في قطر.
          </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-wrap gap-8 mt-12 justify-end"
          >
            {[
      ...
      >
        ...
        >
          <span className="text-white/40 text-sm">اسحب للأسفل</span>
